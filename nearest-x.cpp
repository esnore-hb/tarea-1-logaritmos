 ...
 *        R-Tree con algoritmo Nearest-X, y escritura del resultado a disco.
 * 
 * Proceso:
 * 1. Valida argumentos de línea de comandos (ruta archivo y N puntos)
 * 2. Lee N puntos en formato (x, y) del archivo binario
 * 3. Construye el R-Tree usando el algoritmo nearestX
 * 4. Escribe el árbol completo a un archivo binario .rtree
 * 
